...
<div style="text-align: center;">
  <img src="/pictures/Scree Plot.png" alt="Scree Plot" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 4. Scree Plot
  </div>
</div>
...
<div style="text-align: center;">
  <img src="/pictures/PCA Projection of Obesity and World Indicators.png" alt="PCA Projection of Obesity and World Indicators" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 5. PCA Projection of Obesity and World Indicators
  </div>
</div>

Figure 5 shows how countries compare based on obesity and world indicators using the top two PCA components. Countries with similar characteristics are grouped close together, while unique cases like Samoa or Qatar stand out, showing how different they are from the rest.
...
<div style="text-align: center;">
  <img src="/pictures/Centroids and Country Labels.png" alt="Centroids and Country Labels" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 6. Centroids and Country Labels
  </div>
</div>

Figure 6 shows the groups of countries into 3 clusters based on similarities in obesity and related indicators. The resulting plot shows these clusters using male and female obesity rates, with each color representing a different group. The black X markers indicate the average obesity centroids for each cluster. Outliers like Tonga and Samoa stand out with exceptionally high obesity rates, while other countries form tighter groups with similar profiles.

<div style="text-align: center;">
  <img src="/pictures/Obesity Comparison by Gender and Continent.png" alt="Obesity Comparison by Gender and Continent" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 7. Obesity Comparison by Gender and Continent
  </div>
</div>

Figure 7 shows the comparison of male and female obesity across continents (51 countries), revealing regional patterns and gender differences. It shows that while some continents have balanced obesity rates between men and women, Asia shows more variation.

<div style="text-align: center;">
  <img src="/pictures/Cluster of Health, Economic, and Obesity Indicators.png" alt="Cluster of Health, Economic, and Obesity Indicators" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 8. Cluster of Health, Economic, and Obesity Indicators
  </div>
</div>

This figure shows grouped countries into 3 meaningful clusters based on health spending, economic wealth, and obesity rates. This comparison plot shows that countries with higher health spending tend to have lower obesity rates, while those with moderate GDP and low spending show the highest obesity levels.

<div style="text-align: center;">
  <img src="/pictures/Variance Explained by Components.png" alt="Variance Explained by Components" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 9. Variance Explained by Components
  </div>
</div>

This plot shows that just the first two components capture most of the information in the data, over 95%. This means we can reduce the dataset to 2 dimensions and still retain nearly all its important structure, making it easier to analyze and visualize without much information loss.

<div style="text-align: center;">
  <img src="/pictures/K-means Clustering in PCA Space.png" alt="K-means Clustering in PCA Space" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 10. K-means Clustering in PCA Space
  </div>
</div>

This plot shows how K-Means divided countries into three distinct groups based on health, economy, and obesity patterns. While one group (green) is large and diverse, another (blue) is more tightly packed, suggesting stronger similarity. The red group includes outliers or countries with unique profiles.
...
<div style="text-align: center;">
  <img src="/pictures/K-means Performance.png" alt="K-means Performance" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 11. K-means Performance
  </div>
</div>

This plot suggests that k = 2 is the optimal number of clusters. It provides the highest silhouette score (best separation) and a sharp drop in WSS, indicating meaningful and compact clusters.

<div style="text-align: center;">
  <img src="/pictures/Comparison of Obese and Non-Obese Countries by Continent.png" alt="Comparison of Obese and Non-Obese Countries by Continent" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 12. Comparison of Obese and Non-Obese Countries by Continent
  </div>
</div>

Figure 12 shows that the proportion of obese countries (where adult obesity is ≥ 30%) is significantly higher in Africa, Asia, and South America compared to Europe. It is clear that Europe has no countries with high obesity.
...
<div style="text-align: center;">
  <img src="/pictures/Complete Linkage Dendrogram.png" alt="Complete Linkage Dendrogram" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 13. Complete Linkage Dendrogram
  </div>
</div>
...
<div style="text-align: center;">
  <img src="/pictures/Average Linkage Dendrogram.png" alt="Average Linkage Dendrogram" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 14. Average Linkage Dendrogram
  </div>
</div>
...
<div style="text-align: center;">
  <img src="/pictures/Single Linkage Dendrogram.png" alt="Single Linkage Dendrogram" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 15. Single Linkage Dendrogram
  </div>
</div>

Figure 15 shows that the 40 countries can be divided into 2 main groups based on health and economic indicators. Countries in the same group are more similar, while the two clusters are quite different from each other.

<div style="text-align: center;">
  <img src="/pictures/Ward Linkage Dendrogram.png" alt="Ward Linkage Dendrogram" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 16. Ward Linkage Dendrogram
  </div>
</div>
...
<div style="text-align: center;">
  <img src="/pictures/Comparative Dendrograms.png" alt="Comparative Dendrograms" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 17. Comparative Dendrograms
  </div>
</div>

Figure 17 shows the results of the four linkage methods. Among them, Ward and Complete linkage produce the clearest and most balanced groupings of countries. Average linkage gives acceptable results, but Single linkage is less useful, as it tends to form long, messy chains rather than distinct clusters. Overall, Ward linkage appears to be the most effective choice in this context.

<div style="text-align: center;">
  <img src="/pictures/Cut Dendrogram with 5 Clusters.png" alt="Cut Dendrogram with 5 Clusters" style="max-width: 100%; height: auto;">
  <div style="text-align: center; font-style: italic; font-size: 0.9em; margin-top: 0.5em;">
    Figure 18. Cut Dendrogram with 5 Clusters
  </div>
</div>
...
In the context of SVD, the U matrix represents the projection of countries by observations onto the latent components. This can be interpreted as how each country contributes to different hidden patterns in the data. The V* reflects how each original variable contributes to those components. If a component has high weights for both health expenditure and GDP, that component might represent an “economic development” axis

**Structure in the PCA Projection**

The scatter plot of countries in the first two PCA components revealed visible structure in the data. Countries with similar development and obesity patterns were grouped close together, while outliers such as Qatar and Samoa were far from the rest, indicating unique profiles. This projection is far more informative than plotting two original features like Male Obesity vs. Female Obesity, as it combines variance across all variables into a single reduced space. The PCA plot helps uncover hidden patterns and relationships that are not immediately visible in raw feature plots.

**Clustering Patterns and Interpretation**

After performing K-Means clustering, we identified two primary groups of countries. One group included countries with lower GDP and health spending, often with moderate to high obesity rates. The other group contained more economically developed countries with higher health investments and lower obesity prevalence. A follow-up confusion matrix comparing these clusters with a binary obesity class showed that the clusters partially aligned with obesity status. Hierarchical clustering using Ward linkage grouped countries in a similar way, confirming consistent patterns. Countries in the same cluster often shared socioeconomic characteristics, such as similar health expenditure and urbanization rates, even if they were geographically distant.

**Model Comparison, Limitations, and Takeaways**

We evaluated matrix completion performance using SVD across different missing data rates and ranks. Rank 3 offered the best trade-off between accuracy and complexity, with low mean squared error and high correlation to the true data. PCA was effective in reducing dimensionality and visualizing the dataset’s structure. K-Means clustering performed reasonably well, with a silhouette score of 0.38, indicating moderate cluster separation. However, some overlap between groups suggests that countries may not always cluster cleanly based on health and economic data.
Limitations of our analysis include the relatively small number of countries where n=51, missing values in the original datasets, and potential mismatches in year alignment during the merger process. Additionally, clustering results may be sensitive to the choice of features, number of clusters, and scaling method. Future work could expand the dataset with more countries and years, test additional clustering methods with incorporate geographic and cultural variables to improve interoperability.
